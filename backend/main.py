            ...
            async def _stale_job_reaper():
                ...
                while True:
                    ...
                    try:
                        ...
                        if stale:
                            print(
                                f"🧹 Stale job reaper: marked {stale} stuck jobs as failed", flush=True,
                            )
                        ...
                        if cleaned:
                            print(
                                f'🧹 Removed {cleaned} orphaned full-text blobs', flush=True,
                            )
...
app.add_middleware(
    ...
    same_site='lax', https_only=settings.IS_DEPLOYED,
)
app.add_middleware(
    CORSMiddleware,
