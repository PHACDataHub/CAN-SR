...
async def database_search(
    ...
    if database == 'Pubmed':
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail='Failed to collect citations',
            )
    ...
    try:
        ...
        logging.info(
            f"Uploaded blob '{blob_name}' to container '{settings.STORAGE_CONTAINER_NAME}'",
        )
        ...
        raise HTTPException(
            status_code=500, detail='Failed to write to Azure Blob',
        )
