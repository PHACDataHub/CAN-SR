...
from ..screen.agentic_utils import parse_agent_xml
from ..screen.agentic_utils import resolve_option
from ..screen.prompts import PROMPT_JSON_TEMPLATE
from ..screen.prompts import PROMPT_JSON_TEMPLATE_FULLTEXT
...
async def run_all_start(job_id: str) -> None:
    ...
    try:
        ...
        print(
            f"[run-all] kickoff job_id={job_id} step={step} eligible={len(ids)}", flush=True,
        )
