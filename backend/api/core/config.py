...
class Settings(BaseSettings):
    ...
    STORAGE_CONTAINER_NAME: str = os.getenv(
    ...
    AZURE_STORAGE_ACCOUNT_NAME: str | None = os.getenv(
        'AZURE_STORAGE_ACCOUNT_NAME',
    )
    AZURE_STORAGE_ACCOUNT_KEY: str | None = os.getenv(
    ...
    LOCAL_STORAGE_BASE_PATH: str = os.getenv(
    ...
    AZURE_OPENAI_MODE: str = os.getenv(
    ...
    AZURE_DOC_INT_MODE: str = os.getenv(
    ...
    POSTGRES_MODE: str = os.getenv(
        'POSTGRES_MODE', 'docker',
    ).lower().strip()  # docker|local|azure
    ...
    def postgres_profile(self, mode: str | None = None) -> dict:
        ...
        if m not in {'docker', 'local', 'azure'}:
            raise ValueError(
                'POSTGRES_MODE must be one of: docker, local, azure',
            )
